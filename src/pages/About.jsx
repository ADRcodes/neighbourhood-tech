...
function PaletteButton({ palette, isActive, onSelect }) {
  return (
    <button
      ...
      className={`relative flex flex-col gap-1 rounded-2xl border border-brand-200 px-5 py-4 text-left transition-all ${
        isActive ? "bg-primary text-onprimary shadow-lg shadow-primary/40" : "bg-surface text-text hover:-translate-y-1 hover:shadow-md hover:shadow-brand-200/40"
      }`}
          ...
          <div className="rounded-3xl border border-brand-200/60 bg-surface p-8 shadow-sm shadow-brand-200/20">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              ...
              <button
                type="button"
                onClick={syncToClock}
                className={`rounded-2xl border border-dashed border-brand-200 px-5 py-4 text-left text-sm font-medium transition ${
                  active === "Live Clock" ? "bg-brand-complement text-oncomplement shadow-md shadow-brand-complement/40" : "bg-surface text-text hover:-translate-y-1 hover:shadow-md hover:shadow-brand-200/30"
                }`}
              >
