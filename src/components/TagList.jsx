          ...
          {items.map((t) => {
            ...
            return (
              <button
                ...
                aria-pressed={on}
                className={`inline-flex items-center gap-1 rounded-full border px-3 py-1.5 text-xs font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus/80 ${
                  on
                    ? "bg-primary text-onprimary border-primary shadow-sm shadow-primary/30"
                    : "bg-surface text-text border-brand-200 hover:border-brand-300"
                }`}
              >
